...
import { BubbleMenuDrawer, BubbleMenuExcalidraw, BubbleMenuKatex, BubbleMenuMermaid, BubbleMenuTwitter } from "reactjs-tiptap-editor/bubble-extra";
...
const extensions = [
    ...
    ImageGif.configure({
      GIPHY_API_KEY: 'ugiadada' as string,
    }),
    Blockquote,
    SlashCommand,
    HorizontalRule,
...
export const Editor = () => {
    ...
    const {theme, content, updateContent} = UseEditor();
